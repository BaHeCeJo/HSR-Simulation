...
└── /
    └── test (GET)
        ...
        ├── ing/
        ━E  └── :hello (GET)
        ━E      • (onRequest) ["anonymous()","namedFunction()"]
        ━E      • (onTimeout) ["anonymous()"]
        ━E      • (genericMeta) "meta"
        ━E      • (mixedMeta) ["mixed items",{"an":"object"}]
        ━E      • (objectMeta) {"one":"1","two":2}
        ━E      • (functionMeta) "namedFunction()"
        ━E      • (Symbol(symbolKey)) "Symbol(symbolValue)"
        └── /
            └── :hello (GET) {"version":"1.1.2"}
                :hello (GET) {"version":"2.0.0"}
`
