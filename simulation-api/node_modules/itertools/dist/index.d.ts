...
declare const groupby: typeof igroupby;
declare function igroupby<T, K extends Primitive>(iterable: Iterable<T>, keyFn?: (item: T) => K): Generator<[K, Generator<T, undefined>], undefined>;
declare function groupBy<T, K extends string | number>(iterable: Iterable<T>, keyFn: (item: T) => K): Record<K, T[]>;
declare function indexBy<T, K extends string | number>(iterable: Iterable<T>, keyFn: (item: T) => K): Record<K, T>;
/**
 ...
 *
 */
declare function dupes<T>(iterable: Iterable<T>, keyFn?: (item: T) => Primitive): IterableIterator<T[]>;
/**
