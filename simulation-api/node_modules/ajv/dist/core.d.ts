export { Format, FormatDefinition, AsyncFormatDefinition, KeywordDefinition, KeywordErrorDefinition, CodeKeywordDefinition, MacroKeywordDefinition, FuncKeywordDefinition, Vocabulary, Schema, SchemaObject, AnySchemaObject, AsyncSchema, AnySchema, ValidateFunction, AsyncValidateFunction, AnyValidateFunction, ErrorObject, ErrorNoParams, } from "./types.js";
export { SchemaCxt, SchemaObjCxt } from "./compile.js";
export interface Plugin<Opts> {
    (ajv: Ajv, options?: Opts): Ajv;
    [prop: string]: any;
}
export { KeywordCxt } from "./compile/validate.js";
export { DefinedError } from "./vocabularies/errors.js";
export { JSONType } from "./compile/rules.js";
export { JSONSchemaType } from "./types/json-schema.js";
export { JTDSchemaType, SomeJTDSchemaType, JTDDataType } from "./types/jtd-schema.js";
export { _, str, stringify, nil, Name, Code, CodeGen, CodeGenOptions } from "./compile/codegen.js";
import type { Schema, AnySchema, AnySchemaObject, SchemaObject, AsyncSchema, Vocabulary, KeywordDefinition, AddedKeywordDefinition, AnyValidateFunction, ValidateFunction, AsyncValidateFunction, ErrorObject, Format, AddedFormat, RegExpEngine, UriResolver } from "./types.js";
import type { JSONSchemaType } from "./types/json-schema.js";
import type { JTDSchemaType, SomeJTDSchemaType, JTDDataType } from "./types/jtd-schema.js";
import ValidationError from "./runtime/validation_error.js";
import MissingRefError from "./compile/ref_error.js";
import { ValidationRules } from "./compile/rules.js";
import { SchemaEnv } from "./compile.js";
import { Code, ValueScope } from "./compile/codegen.js";
