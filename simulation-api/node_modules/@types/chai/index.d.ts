...
declare global {
    namespace Chai {
        ...
        export interface Assert {
            ...
            /**
             * Asserts that ‘haystack Eincludes ‘needle E Can be used to assert the inclusion of a subset of properties in an object.
             *
             * Enables the use of dot- and bracket-notation for referencing nested properties.
             * ‘[] Eand  E Ein property names can be escaped using double backslashes.Asserts that ‘haystack Eincludes ‘needle E
             * Can be used to assert the inclusion of a subset of properties in an object.
             * Enables the use of dot- and bracket-notation for referencing nested properties.
             * ‘[] Eand  E Ein property names can be escaped using double backslashes.
             *
             * @param haystack
             * @param needle
             * @param message   Message to display on error.
            ...
            /**
             * Asserts that ‘haystack Edoes not include ‘needle E Can be used to assert the absence of a subset of properties in an object.
             *
             * Enables the use of dot- and bracket-notation for referencing nested properties.
             * ‘[] Eand  E Ein property names can be escaped using double backslashes.Asserts that ‘haystack Eincludes ‘needle E
             * Can be used to assert the inclusion of a subset of properties in an object.
            ...
            /**
             * Asserts that ‘haystack Eincludes ‘needle E Can be used to assert the inclusion of a subset of properties in an object while checking for deep equality
             *
             * Enables the use of dot- and bracket-notation for referencing nested properties.
             * ‘[] Eand  E Ein property names can be escaped using double backslashes.Asserts that ‘haystack Eincludes ‘needle E
             * Can be used to assert the inclusion of a subset of properties in an object.
            ...
            /**
             * Asserts that ‘haystack Edoes not include ‘needle E Can be used to assert the absence of a subset of properties in an object while checking for deep equality.
             *
             * Enables the use of dot- and bracket-notation for referencing nested properties.
             * ‘[] Eand  E Ein property names can be escaped using double backslashes.Asserts that ‘haystack Eincludes ‘needle E
             * Can be used to assert the inclusion of a subset of properties in an object.
            ...
            /**
             * Asserts that ‘haystack Eincludes ‘needle E Can be used to assert the inclusion of a subset of properties in an object while ignoring inherited properties.
             *
             * @param haystack
             * @param needle
             * @param message   Message to display on error.
            ...
            /**
             * Asserts that ‘haystack Eincludes ‘needle E Can be used to assert the absence of a subset of properties in an object while ignoring inherited properties.
             *
             * @param haystack
             * @param needle
             * @param message   Message to display on error.
            ...
            /**
             * Asserts that ‘haystack Eincludes ‘needle E Can be used to assert the inclusion of a subset of properties in an object while ignoring inherited properties and checking for deep
             *
             * @param haystack
             * @param needle
             * @param message   Message to display on error.
            ...
            /**
             * Asserts that ‘haystack Eincludes ‘needle E Can be used to assert the absence of a subset of properties in an object while ignoring inherited properties and checking for deep equality.
             *
             * @param haystack
             * @param needle
             * @param message   Message to display on error.
