		...
		*/
		return function generate(localName, filepath) {
			...
			return interpolateName({ resourcePath: filepath }, name, {
				...
				context
			}).replace(/* @__PURE__ */ new RegExp("[^a-zA-Z0-9\\-_\xA0-�E�]", "g"), "-").replace(/^((-?[0-9])|--)/, "_$1");
		};
	};
}));
//#endregion
...
var require_unesc = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	*/
	function gobbleHex(str) {
		...
		if (codePoint >= 55296 && codePoint <= 57343 || codePoint === 0 || codePoint > 1114111) return ["�E�", hex.length + (spaceTerminated ? 1 : 0)];
