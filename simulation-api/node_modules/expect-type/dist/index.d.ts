import type { StrictEqualUsingBranding } from '.js';
import type { ExpectAny, ExpectArray, ExpectBigInt, ExpectBoolean, ExpectFunction, ExpectNever, ExpectNull, ExpectNullable, ExpectNumber, ExpectObject, ExpectString, ExpectSymbol, ExpectUndefined, ExpectUnknown, ExpectVoid, MismatchInfo, Scolder } from '.js';
import type { ConstructorOverloadParameters, OverloadParameters, OverloadReturnTypes, OverloadsNarrowedByParameters } from '.js';
import type { AValue, DeepPickMatchingProps, Extends, IsUnion, MismatchArgs, Not, StrictEqualUsingTSInternalIdenticalToOperator } from '.js';
export * from '.js';
export * from '.js';
export * from '.js';
export * from '.js';
...
export interface PositiveExpectTypeOf<Actual> extends BaseExpectTypeOf<Actual, {
     ...
     * ```ts
     * // ❁EThe following line doesn't compile, even though the types are arguably the same.
