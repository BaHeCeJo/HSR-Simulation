...
function usage () {
  console.log(`
    ...
    ・all        ⁁Erun all benchmarks (takes a while)
    ・basic      ⁁Elog a simple string
    ・object     ⁁Elogging a basic object
    ・deep-object ⁁Elogging a large object
    ・multi-arg   ⁁Emultiple log method arguments
    ・child      ⁁Echild from a parent
    ・child-child ⁁Echild from a child
    ・child-creation ⁁Echild constructor
    ・formatters ⁁Edifference between with or without formatters
