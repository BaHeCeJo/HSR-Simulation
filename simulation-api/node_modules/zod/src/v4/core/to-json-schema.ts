...
export interface JSONSchemaGeneratorParams {
   ...
   * - `"draft-2020-12"`  EDefault. JSON Schema Draft 2020-12
   * - `"draft-07"`  EJSON Schema Draft 7
   * - `"draft-04"`  EJSON Schema Draft 4
   * - `"openapi-3.0"`  EOpenAPI 3.0 Schema Object */
  target?: "draft-04" | "draft-07" | "draft-2020-12" | "openapi-3.0" | ({} & string) | undefined;
  /** How to handle unrepresentable types.
   * - `"throw"`  EDefault. Unrepresentable types throw an error
   * - `"any"`  EUnrepresentable types become `{}` */
   ...
   * - `"output"`  EDefault. Convert the output schema.
   * - `"input"`  EConvert the input schema. */
  io?: "input" | "output";
  cycles?: "ref" | "throw";
  reused?: "ref" | "inline";
  external?:
