 ...
 * The customSerializer accepts one parameter  Ethe newly serialized error object  Eand returns the new (or updated) error object.
 */
 ...
 * This allows custom serializers to work with the already serialized object.
 * The customSerializer accepts one parameter  Ethe newly serialized request object  Eand returns the new (or updated) request object.
 */
 ...
 * This allows custom serializers to work with the already serialized object.
 * The customSerializer accepts one parameter  Ethe newly serialized response object  Eand returns the new (or updated) response object.
 */
