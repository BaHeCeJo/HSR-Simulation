...
import { stringify } from '.js';
import { deepClone, getOwnProperties, getType as getType$1 } from '.js';
import '.js';
...
function requireBuild () {
	...
	// ΁E= N - M is negative of baDeltaLength = bLength - aLength
	// D is d
	// k is kF
	// k + ΁Eis kF = kR - baDeltaLength
	// V is aIndexesF or aIndexesR (see comment below about Indexes type)
	// index intervals [1, N] and [1, M] are [0, aLength) and [0, bLength)
	// starting point in forward direction (0, 0) is (-1, -1)
	// starting point in reverse direction (N + 1, M + 1) is (aLength, bLength)

	// The “edit graph Efor sequences a and b corresponds to items:
	...
	// The length of what Myers paper calls a “snake Ein a forward path.
	...
	// The length of what Myers paper calls a “snake Ein a reverse path.
	  ...
	  for (let iF = 0, kF = -d; iF <= nF; iF += 1, kF += 2) {
	    ...
	    if (kMinOverlapF <= kF && kF <= kMaxOverlapF) {
	      ...
	      if (iR <= iMaxR && aIndexesR[iR] - 1 <= aLast) {
	        // Unlike the Myers algorithm which finds only the middle “snake E	        // this package can find two common subsequences per division.
	...
	// and because this function will throw the “no overlap Eerror.
	const divide = (
	  nChange,
	  aStart,
	  aEnd,
	...
	// DO NOT CALL if start === end, because interval cannot contain common items
	// and because divide function will throw the “no overlap Eerror.
