...
class SnapshotState {
	...
	_inferInlineSnapshotStack(stacks) {
		...
		// custom matcher registered via expect.extend()  Ethe wrapper function
...
*
* Compares consecutive rendered outputs from the current session  E* when two consecutive polls produce the same rendered string,
...
async function getStableSnapshot({ adapter, poll, interval, timedOut, match }) {
	...
	while (true) {
		try {
			...
			// poll() threw  Ereset stability baseline and retry
...
/** Type-safe `Promise.race`  Etells you which promise won. */
