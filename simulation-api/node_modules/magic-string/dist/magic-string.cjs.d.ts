...
export default class MagicString {
	 ...
	 *
	 * The fourth argument is optional. It can have a storeName property  Eif true, the original name will be stored
	 * for later inclusion in a sourcemap's names array  Eand a contentOnly property which determines whether only
	 ...
	 *
	 * The fourth argument is optional. It can have a storeName property  Eif true, the original name will be stored
	 * for later inclusion in a sourcemap's names array  Eand an overwrite property which determines whether only
	 * the content is overwritten, or anything that was appended/prepended to the range as well.
	 */
